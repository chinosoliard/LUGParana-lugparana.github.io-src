...
BLOG_AUTHOR = "LUG Paraná"  # (translatable)
BLOG_TITLE = "LUG Paraná"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://lugparana.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://lugparana.org/"
BLOG_EMAIL = "lugparana@listas.usla.org.ar"
BLOG_DESCRIPTION = "Linux User Group Paraná (Argentina)"  # (translatable)
